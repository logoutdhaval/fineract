...
public class GlobalConfigurationHelper {
    ...
    private static ArrayList<HashMap> getAllDefaultGlobalConfigurations() {
        ...
        isPrincipalCompoundingDisabled.put("id", 44);
        isPrincipalCompoundingDisabled.put("name", REPORTS_PAGINATION_NUMBER_OF_ITEMS_PER_PAGE);
        isPrincipalCompoundingDisabled.put("value", 20);
        isPrincipalCompoundingDisabled.put("enabled", true);
        isPrincipalCompoundingDisabled.put("trapDoor", false);
